...
export default function CommentMenu({ commentId, rerender }) {
  ...
  const handleDelete = async () => {
    ...
    await dispatch(deleteComment(commentCredentials)).then(() => {
      setSuccess(true);
      rerender(true);
    });
  };
  ...
  return (
    <div>
      <div onClick={handleClick} className="cursor-pointer">
        <img className="w-4 flex " src="assets/icons/menu.svg" alt="" />
      </div>
      <StyledMenu
